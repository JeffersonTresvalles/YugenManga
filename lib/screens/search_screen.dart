...
class _SearchScreenState extends State<SearchScreen> {
  ...
  static const Color _purple = Color(0xFF8E8FFA);
  static const Color _deepPurple = Color(0xFF4C04C9);
          ...
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                suffixIcon: IconButton(
                  icon: const Icon(Icons.clear, color: _purple),
                  onPressed: () {
                    _controller.clear();
                    setState(() {
                      _results = [];
                ...
                focusedBorder: OutlineInputBorder(
                  borderRadius: BorderRadius.circular(14),
                  borderSide: const BorderSide(color: _deepPurple, width: 1.5),
                ),
              ),
            ...
            Expanded(
              child: _isLoading
                  ...
                  ? const Center(
                      child: CircularProgressIndicator(color: _deepPurple))
                  : _error != null
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child:
                Icon(icon, size: 38, color: _deepPurple.withValues(alpha: 0.5)),
          ),
          const SizedBox(height: 16),
          Text(message,
              style: GoogleFonts.nunito(
